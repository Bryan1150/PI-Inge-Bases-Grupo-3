...
const Space = {
	...
	estrellas: {
		...
		objects: {
			...
			ganymede:  { name: "Ganimedes (Satélite de Jupiter)",   diameter:    5268, color: "#8d7c69", type: "satellite", hasImg: true, aka: "Satélite más grande de Júpiter" },
			callisto:  { name: "Calisto (Satélite de Jupiter)",   diameter:    4820, color: "#91775e", type: "satellite", hasImg: true, aka: "Segundo satélite más grande de Júpiter" },
			...
			iapetus:   { name: "Jápeto (Satélite de Saturno)",    diameter:    1469, color: "#c3c1b2", type: "satellite", hasImg: true, aka: "Tercer satélite más grande de Saturno" },
			...
			tethys:    { name: "Tetis (Satélite de Saturno)",     diameter:    1062, color: "#b0afaf", type: "satellite", hasImg: true, aka: "Quinto satélite más grande de Saturno" },
			enceladus: { name: "Encélado (Satélite de Saturno)",  diameter:     504, color: "#aeaeae", type: "satellite", hasImg: true, aka: "Sexto satélite más grande de Saturno" },
			...
			oberon:    { name: "Oberón (Satélite de Urano)",       diameter:    1523, color: "#ae9b94", type: "satellite", hasImg: true, aka: "Segundo satélite más grande de Urano" },
