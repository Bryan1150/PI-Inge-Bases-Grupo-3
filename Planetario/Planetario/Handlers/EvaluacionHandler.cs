...
namespace Planetario.Handlers
{
    public class EvaluacionHandler : BaseDatosHandler
    {
        ...
        public CuestionarioEvaluacionRecibirModel obtenerCuestionario(string nombreCuestionaro)
        {
            string consulta = "SELECT * FROM CuestionarioEvaluacion WHERE nombreCuestionarioPK = '" + nombreCuestionaro + "';";
            ...
            CuestionarioEvaluacionRecibirModel evaluacion = new CuestionarioEvaluacionRecibirModel
            {
                ...
                Preguntas = obtenerPreguntasDeCuestionario(nombreCuestionaro)
            };
            return evaluacion;
        }
        

        public List<string> obtenerPreguntasDeCuestionario(string nombreCuestionaro)
        {
            string consulta = "SELECT PE.pregunta FROM dbo.PreguntasEvaluacion PE " +
                "JOIN dbo.Cuestionario C ON C.nombreCuestionarioPK = PE.nombreCuestionarioFK";
        ...
        public List<string> obtenerComentariosDeCuestionario(string nombreCuestionaro)
        {
            string consulta = "SELECT PE.pregunta FROM dbo.PreguntasEvaluacion PE " +
                "JOIN dbo.Cuestionario C ON C.nombreCuestionarioPK = PE.nombreCuestionarioFK";
